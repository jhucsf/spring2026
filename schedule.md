...
------------------ | ------------ | ------- | ----------
Jan 21 | [Course overview](lectures/lecture01-public.pdf) | *CSAPP* 1.1–1.9 | 
Jan 23 | [Data representation, addresses](lectures/lecture02-public.pdf) | *CSAPP* 2.1 | 
Jan 26 | [Integer representation](lectures/lecture03-public.pdf) | *CSAPP* 2.2 | 
Jan 28 | [Integer arithmetic](lectures/lecture04-public.pdf) | *CSAPP* 2.3 | <span class='tentative'>A1 MS1 due</span>
Jan 30 | [Floating point](lectures/lecture05-public.pdf) | *CSAPP* 2.4 | 
Feb 2 | [Machine-level program representation](lectures/lecture06-public.pdf), [addLongs.zip (example code)](lectures/addLongs.zip) | *CSAPP* 3.1–3.4 | 
Feb 4 | [ALU operations, arithmetic](lectures/lecture07-public.pdf), [alu.zip (example code)](lectures/alu.zip) | *CSAPP* 3.5 | <span class='tentative'>A1 MS2 due</span>
...
Feb 13 | [Assembly language in class exercise](lectures/assembly-exercise-public.pdf) |  | <span class='tentative'>A2 MS1 due</span>
...
Feb 20 | [Pipelines](lectures/lecture13-public.pdf) | <i>P&amp;H</i> 4.5–4.7 | <span class='tentative'>A2 MS2 due</span>
Feb 23 | Program optimization (ILP, memory, profiling): see Canvas for slides | *CSAPP* 5.9–5.14 | 
Feb 25 | [Memory hierarchy](lectures/lecture15-public.pdf) | *CSAPP* 6.1–6.3 | 
Feb 27 | Exam 1 review session |  | <span class='tentative'>A2 MS3 due</span>
...
Apr 20 | [Parallelism, concurrency issues](lectures/lecture31-public.pdf), [synch2.zip (example code)](lectures/synch2.zip) | *CSAPP* 12.6–12.7 | 
